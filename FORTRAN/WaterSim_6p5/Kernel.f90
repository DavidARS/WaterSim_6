...
! last write was: 01.24.14,06.09.14,07.20.14,07.30.14,04.18.19
! -------------------------------------------------------------
! 
 ...
 contains
    ...
    subroutine openRelease()
        ...
        if(gpl_writeLog)then
                ...
                if(gpl_111)then
                 open(111,FILE=(trim(lvc_outputPath)//'OneHundredEleven.txt'), status='replace')                        
                endif
                    ...
                    call pDemand(T,gvi)                             ! ProviderPopulationandDemand.f90
                     call pWaterForVadose_s(T,gvi,lvl_flag)         ! Demand.f90
                      call pWaterForDirectInject_s(T,gvi,lvl_flag)  ! Demand.f90
                        call pRainWaterHarvest(T,gvi,lvl_flag)      ! Demand.f90
                         call pStormWaterHarvest(T,gvi,lvl_flag)    ! Water_CityModel.f90
                          call pGrayWater(T,gvi,lvl_flag)           ! Water_CityModel.f90
