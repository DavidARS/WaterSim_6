        ...
        ! ----------------------------------
         subroutine aDemandSupply(T,vGP,vLP)
            ...
            ! ---------------------------------- Types ----------------------------------------------------------------
             ...
             real  :: lvf_Eleven,lvf_Twelve,lvf_Thirteen,lvf_Fourteen,lvf_fifteen,lvf_sixteen,lvf_seventeen,lvf_eighteen
                         ...
                         ! ===================================================================================================
                          lvf_One=0; lvf_Two=0; lvf_Three=0; lvf_Four=0; lvf_Five=0; lvf_Six=0; lvf_Seven=0
                           lvf_Eight=0; lvf_Nine=0; lvf_Ten=0; lvf_Eleven=0; lvf_Twelve=0; lvf_Thirteen=0; lvf_Fourteen=0
                            lvf_fifteen=0;lvf_sixteen=0;lvf_seventeen=0;lvf_eighteen=0
                          ...
                          do j = 1,gpi_unusedNonPotable,1
                           ...
                           !
                           lvf_fifteen=(gvf_WaterDemand_acft(i,j,15))
                           lvf_sixteen=(gvf_WaterDemand_acft(i,j,16))
                           lvf_seventeen=(gvf_WaterDemand_acft(i,j,17))
                           lvf_eighteen=(gvf_WaterDemand_acft(i,j,18))
                           ...
                           write(4,5)T%year,i,j,lvf_One,lvf_Two,lvf_Three,lvf_Four,lvf_Five,lvf_Six,lvf_Seven, &
                                ...
                                lvf_fifteen,lvf_sixteen,lvf_seventeen,lvf_eighteen
                           !                    
                          end do
                        end do
                      endif
...
5           format(I4,1x,2(I2,1x),18(F12.1,1x))
