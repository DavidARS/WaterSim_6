...
!   logical, parameter :: gpl_testing2016=.false.    
   ...
   logical, parameter :: gpl_108=.false.
   logical, parameter :: gpl_109=.false.
   logical, parameter :: gpl_110=.false.
   !
...
Module gm_VersionControl
  ...
  !
  integer, parameter :: gdi_Month=04
  integer, parameter :: gdi_Day  =15
  integer, parameter :: gdi_Year =19
  integer, parameter :: gdi_Hour =16
  integer, parameter :: gdi_Min  =56
  !
