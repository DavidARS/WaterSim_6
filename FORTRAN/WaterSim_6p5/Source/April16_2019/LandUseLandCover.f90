...
!                 endif
                ...
                100 format(I4,2x,I2,2x,I2,2x,2(F8.2,1x),I2,2x,2(F5.1,1x))
                !
                if(gpl_103)then
                ...
                140 format(I4,3x,I2,3x,I2,3x,4(F8.2,2x),I2,2x,2(F5.1,1x))
                !    
                if(gpl_104)then
                ...
                !
                310 format(I4,1x,I2,1x,I2,1x,3(F15.1,1x),I2,2x,2(F5.1,1x))
                !
                if(gpl_105)then
                write(105,410)year,lclu,provider,lvf_pop,lvf_ZeroTwo,lvf_PopGrowthOut,lvf_EffOut
                endif
                410 format(I4,1x,I2,1x,I2,1x,F12.1,I2,2x,2(F5.1,1x))
                !   
                if(gpl_106)then
