      ...
      use gm_GlobalData
        ...
        !
            ...
            ! if(lvc_DPath_ .ne. ' ')then
              !lvc_dataPath=lvc_DPath_ 10.24.2017 das - does this "fix" my issue with the web service?
              lvc_dataPath=trim(lvc_DPath_)
            ! endif
            endif
            !
            if(gpl_release)then
...
!             gvf_cumulativeCredit(Uprovider)=gvf_cumulativeCredit(Uprovider)+lvf_creditTransfer(Uprovider)
            ...
            !if(T%year .lt. gvi_baseYear+1)then
            if(T%year .lt. gvi_baseYear)then
               !
 ...
 use lms_LULC
    ...
    ! ============================
        ...
        if(gvl_LULCstatus)then
            ! WaterSim 6 simulations using Land-Cover Land-use
