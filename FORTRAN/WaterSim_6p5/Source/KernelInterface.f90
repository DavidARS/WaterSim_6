...
!
! This has been revised 11/20/16
...
subroutine getGrayWaterResidential(count, values)
   use lms_CitiWaterBudgets
    ...
    integer, dimension(1:count) :: values
    ! 
    forall(i=1:count) values(i)= go_graywaterWaterUsed_AF(i)*gvf_parm_WStoRes_prop(i) !go_GrayWaterReclaimed_acft(i,1) 
 return
end subroutine
! ===========================================================
! 
...
subroutine getGrayWaterCommercial(count, values)
   use lms_CitiWaterBudgets
    ...
    integer, dimension(1:count) :: values
    ! 
    forall(i=1:count) values(i)= go_graywaterWaterUsed_AF(i)*gvf_parm_WStoCom_prop(i)  !go_GrayWaterReclaimed_acft(i,2) 
 return
end subroutine
! ===========================================================
! 
...
subroutine getGrayWaterIndustrial(count, values)
   use lms_CitiWaterBudgets
    ...
    integer, dimension(1:count) :: values
    ! 
    forall(i=1:count) values(i)= go_graywaterWaterUsed_AF(i)*gvf_parm_WStoInd_prop(i) !go_GrayWaterReclaimed_acft(i,3) 
 return
end subroutine
! ===========================================================
! 
...
subroutine get_harvestedStormWater(count, values)
    ...
    !forall(i=1:count) values(i)= go_stormWaterUsedUsed_AF(i)
    ! 
 return
end subroutine
!
