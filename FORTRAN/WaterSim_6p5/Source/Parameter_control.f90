...
!          go_NCSmax_acft(lvi_countSRP)=0
        ...
        gvf_Release=0
        ! 10.14.13
!        gvf_ratioVerdeFlowsPostEnv=0.
!        gvf_ratioSaltTontoFlowsPostEnv=0.
        !
    ...
    subroutine initPopAndDemand(i)
        ...
        go_CAPunusedPriority5(i)=0
             ...
             !
!             go_OnProjectNetDemand_acft(i)=0
!             go_OffProjectNetDemand_acft(i)=0
                    ...
                    if(T%year <=gvi_baseYear+1)then
                     call checkDefault(i,T)
                      ...
                      if(gvl_defaultRun(5,i))then
                        ...
                        ! Happens immediately; no time lag delay
