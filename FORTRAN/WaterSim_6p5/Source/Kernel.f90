    ...
    ! ---------------------------
     ...
     subroutine upStreamK(T,year)
      use gm_ModelControl
        ...
        real :: totalYears
        real :: lvf_diffYears
        real,parameter :: lpf_finite=0.05
        ! =========================
        !
        ...
        ! =====================
          ...
          lvf_diffYears = max(0,(year - gvi_baseYear))
            T%propYears_2060=0
            T%propYears=0
           T%propYears_2060= 1-(lvf_diffYears/(2060-gvi_baseYear))
           T%propYears= 1-(lvf_diffYears/(totalYears-(gvi_baseYear- T%startyear )))
           if(T%propYears_2060 < lpf_finite)T%propYears_2060=0
      ...
      use gm_GlobalData
        ...
        !
            if(gpl_writeLog)then
                ...
                !
                 open(7,FILE=(trim(lvc_outputPath)//'Log.txt'), status='replace')
