...
! last write was: 01.15.13,07.21.14,07.22.14,05.26.17
! -----------------------------------------------------
!
...
Module gm_GlobalData
   ...
   integer, parameter :: gpi_maxSVTrec=700
    ...
    ! records SVT data
    ! For do loops
   integer, parameter :: gpi_dailySVTrec= 25932!24837 !24471
    ! For array defintion
   integer, parameter :: gpi_dailySVT= 25932 !24837 !24471 !9150 was 366*25 years
...
!   logical, parameter :: gpl_testing2016=.false.    
   ...
   logical, parameter :: gpl_104=.true.
   logical, parameter :: gpl_105=.true.
   logical, parameter :: gpl_106=.true.
   logical, parameter :: gpl_107=.true.
   !
   logical, parameter :: gpl_108=.true.
   logical, parameter :: gpl_109=.true.
   logical, parameter :: gpl_110=.true.
   logical, parameter :: gpl_111=.true.
   !
   logical, parameter :: gpl_writeLog=.true.
   logical :: gvl_writeToLog=.true.   
   !
...
Module gm_VersionControl
  ...
  integer, parameter :: gdi_Vers=7
  integer, parameter :: gdi_SubVers=8
  !
  integer, parameter :: gdi_Month=9
  integer, parameter :: gdi_Day  =09
  integer, parameter :: gdi_Year =19
  integer, parameter :: gdi_Hour =10
  integer, parameter :: gdi_Min  =58
  !
