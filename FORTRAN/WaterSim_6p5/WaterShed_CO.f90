...
10        continue
       ...
       ! -------------------------
        ...
        subroutine readFiles_b()
            ...
            integer :: i,j,iyear
            integer :: rec,ios
            real :: A(2000:2010),temp(2000:2015,2)    
            !real :: A(2000:2010),temp(2000:2014,2)  
            ! ========================================
                !
                ios=0
                rec=0
                ...
                ! 06.02.17 DAS
                ! Read Unit 10; Colorado River base data 2000 through 2014 data
                ...
                LU=10
                rec=0
                   read(LU,*,err=1,iostat=ios)((temp(i,j),j=1,2),i=2000,2015)
                   !read(LU,*,err=1,iostat=ios)((temp(i,j),j=1,2),i=2000,2014)

                 close(LU)
                ! 
                do i = 1,16,1
                !do i = 1,15,1
                  lvd_iflowCObase_acft(i)=0
                 lvd_iflowCObase_acft(i)=temp(i+1999,2)
                end do
                !-----------------------------------------------------
                !
                do i =1,1250,1
    ...
    use gm_Euler
     use gm_DataAndSensitivity
      ...
      !
            ...
            real,parameter :: mpf_meadDead=2.0 ! 895 feel msl
   ...
   contains
    ! ======
      ...
      subroutine aFlow_b(T,acft)
        ...
        !integer :: stop=15 ! use 13 for 2000 through 2012
        integer :: stop=16 ! use 13 for 2000 through 2012
