...
namespace WaterSimDCDC
{
    ...
    public abstract class WaterSimManagerClass : IDisposable
    {
        ...
        // Version Strings
        const string _APIVersion = "10.0.0";  // latest version of API
        string FAPIVersion = "";
        ...
        internal const int FDefaultStopYear = 2086;
        ///-----------------------------------------------------------
        /// <summary>
        ...
        public virtual int DefaultMaxStopYear()
        {
            return FDefaultStopYear - 1;
        }
        ...
        * Calls close files afer running last year
        ...
        ProviderIntArray GP = new ProviderIntArray(0);
        //----------------------------------------------------------------------------------
...
//            _pm.AddParameter(new ModelParameterClass(eModelParam.epSimulation_End_Year, "Simulation End Year", "STOPYR", rangeChecktype.rctCheckRange, DefaultMinStopYear() + 1, DefaultMaxStartYear() + 1, geti_Simulation_End_Year, seti_Simulation_End_Year, RangeCheck.NoSpecialBase));
            _pm.AddParameter(new ModelParameterClass(eModelParam.epSimulation_End_Year, "Simulation End Year", "STOPYR", rangeChecktype.rctCheckRange, DefaultMinStopYear() + 1, DefaultMaxStopYear() + 1, geti_Simulation_End_Year, seti_Simulation_End_Year, RangeCheck.NoSpecialBase));
